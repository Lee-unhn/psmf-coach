...
- **Dynamic daily menu** — picks the next day's type (all-whey / solid-meal / carb refeed / diet break) from your previous-day data + recent trend, and builds each meal from a food database with per-item macros + cost.
